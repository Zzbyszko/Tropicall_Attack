...
namespace Projekt_JPWP
{
    public partial class Phase2 : Form
    {
        public Phase2()
        {
            ...
            {
                GlobalData.Funds = 10000; //na początek gry trzeba zaktualizować fundusze
        ...
        private void button1_Click(object sender, EventArgs e) //Toalety 12
        {
        ...
        private void button2_Click(object sender, EventArgs e) //pokój nauczycielski 22
        {
            //Po pierwszym wybraniu zadania trzeba zablokować możliwość wybrania tego samego zadania ponownie
            this.button2.Enabled = false;
        ...
        private void button3_Click(object sender, EventArgs e) //hala sportowa 32
        {
            //Po pierwszym wybraniu zadania trzeba zablokować możliwość wybrania tego samego zadania ponownie
            this.button3.Enabled = false;
        ...
        private void button8_Click(object sender, EventArgs e) //przycisk powrotu do Menu
        {
        ...
        private void button9_Click(object sender, EventArgs e) //Zapisywanie
        {
            Files.SaveToFile();
