...
namespace Projekt_JPWP
{
    public partial class Phase1 : Form
    {
        public Phase1()
        {
            ...
            {
                GlobalData.Funds = 10; //na początek gry trzeba zaktualizować fundusze
        ...
        private void button1_Click(object sender, EventArgs e) //TV 11
        {
        ...
        private void button2_Click(object sender, EventArgs e) //Wanna 21
        {
            //Po pierwszym wybraniu zadania trzeba zablokować możliwość wybrania tego samego zadania ponownie
            this.button2.Enabled = false;
        ...
        private void button3_Click(object sender, EventArgs e) //Okno 31
        {
            //Po pierwszym wybraniu zadania trzeba zablokować możliwość wybrania tego samego zadania ponownie
            this.button3.Enabled = false;
